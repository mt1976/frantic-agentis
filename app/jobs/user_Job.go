...
func (j *UserMaintenanceJob) Description() string {
	return "This job runs every day at 00:00:00 to perform user maintenance tasks."
}
...
func jobProcessor(job *UserMaintenanceJob, db *database.DB) {
	// This is the main function
	jobName := stringHelpers.SQuote(job.Name())
